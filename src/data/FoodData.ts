    ...
    public static generateData(): FoodIngredientsModel[]{
        const foods: FoodIngredientsModel[] = [
            new FoodIngredientsModel({
                food: new FoodModel({ id:1, name: 'Comida 1', description: 'Descripción 1', photoUrl: food_image, price: 40 }),
                ingredients: [
            ...
            new FoodIngredientsModel({
                food: new FoodModel({ id:2, name: 'Comida 2', description: 'Descripción 2', photoUrl: food_image, price: 80 }),
                ingredients: [
